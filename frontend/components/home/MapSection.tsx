...
/**
 * Map loads only when the section approaches the viewport (or on click).
 * Avoids ~400KB Google Maps JS on initial paint / Lighthouse cold load.
 */
export default function MapSection() {
  ...
  useEffect(() => {
    ...
    const io = new IntersectionObserver(
      ...
      // Only when near viewport — not on initial load for long pages
  ...
  const mapDirectionsUrl =
    "https://www.google.com/maps/place/Dastorkon+(%D0%94%D0%B0%D1%81%D1%82%D0%BE%D1%80%D0%BA%D0%BE%D0%BD)/@42.4984702,78.3833704,17z/data=!3m1!4b1!4m6!3m5!1s0x38865c079b3c410f:0xfd331f09fec7bda4!8m2!3d42.4984702!4d78.3833704!16s%2Fg%2F1ptzpmm03";
  const iframeSrc =
    "https://maps.google.com/maps?q=42.4984702,78.3833704&z=16&output=embed&iwloc=near";
  ...
  return (
    <section id="contacts" className="relative z-0 w-full bg-[#5a1212] text-white overflow-hidden">
      ...
      <div className="relative border-b border-brand-dark/10 z-10 grid grid-cols-1 md:grid-cols-[25%_75%] w-full min-h-[400px] md:min-h-[460px]">
        ...
        <div className="flex flex-col justify-center px-6 py-10 sm:px-10 md:pl-10 md:pr-6 lg:pl-16 lg:pr-6 text-white w-full border-r border-white/10 md:border-b-0 border-b">
          ...
          <div className="flex flex-col gap-y-5 font-sans">
            <div className="flex flex-col gap-1">
              ...
              <p className="text-xs md:text-sm font-light leading-relaxed">{t("address_value")}</p>
            </div>
        ...
        <div
          ref={mapContainerRef}
          className={`relative w-full h-[350px] md:h-auto min-h-[350px] group overflow-hidden bg-black ${mapActive ? "" : "cursor-pointer"}`}
          onClick={() => {
          ...
          role={mapActive ? undefined : "button"}
          tabIndex={mapActive ? undefined : 0}
          aria-label={mapActive ? undefined : t("title")}
        >
          <div className="w-full h-full grayscale invert-[0.92] contrast-[1.2] opacity-60 group-hover:grayscale-0 group-hover:invert-0 group-hover:opacity-100 transition-all duration-[850ms] ease-[cubic-bezier(0.25,1,0.5,1)]">
            {mapActive ? (
              ...
              /* Lightweight placeholder until iframe mounts */
